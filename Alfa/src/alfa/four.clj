...
(defn sol50p
	"lim is the maximum limit for the sum and bhn is the upper bound for sieve"
	[^long lim ^long bhn]
	(->> (eduction
...
(defn tribo-mod?
	"Returns true if a number divides any term of tribonacci"
	[^long n]
...
(defn pascal
	"Building pascal pyramid, where layer is the nth layer in the pyramid"
